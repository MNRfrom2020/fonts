...
[![Solaiman Lipi Font Preview](https://fonts.mnr.bd/fonts/solaiman-lipi/solaiman-lipi-font.jpg)](https://fonts.mnr.bd/solaiman-lipi/)

🌐 [fonts.mnr.bd/solaiman-lipi](https://fonts.mnr.bd/solaiman-lipi/)

## Embed:
To use the Solaiman Lipi font on your website, add the following code to your HTML `<head>` section:
```html
<link href='https://fonts.mnr.bd/css/solaiman-lipi.css' rel='stylesheet'>
```

or,
```html
<style>
  @import url('https://fonts.mnr.bd/css/solaiman-lipi.css');
</style>
```
...
> ```
> https://fonts.mnr.bd/css/solaiman-lipi.min.css
> ```
...
For more details, visit: [Solaiman Lipi on MNR Fonts](https://fonts.mnr.bd/solaiman-lipi/#about).